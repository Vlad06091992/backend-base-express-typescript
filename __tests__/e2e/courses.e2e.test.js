...
describe('test for /courses', () => {
    ...
    it('should added new course(vue)', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield (0, supertest_1.default)(index_1.app).get('/courses').expect(http_statuses_1.HTTP_STATUSES.OK_200, [createdCourse1]);
    }));
    ...
    it('should added new course(angular)', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const coursesResponse = yield (0, supertest_1.default)(index_1.app).get('/courses');
